  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#fdfdfc] px-5 font-sans text-[#2f251f]">
      <main className="w-full max-w-[390px]">
        ...
        <section className="rounded-xl border border-[#ded7d1] bg-white px-6 py-7 shadow-sm">
          <div className="mb-7 text-center">
            ...
            <p className="mt-2 text-sm text-[#6f625d]">
              Acesso para equipe e dentistas voluntários
            </p>
          </div>
        ...
        <Link
          to="/"
          className="mt-5 flex w-full items-center justify-center gap-2 rounded-lg border border-[#ded7d1] bg-white px-4 py-3 text-sm font-semibold text-[#2f251f] transition hover:bg-[#f7f4f1]"
        >
