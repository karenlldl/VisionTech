        ...
        <main className="flex flex-1 flex-col items-center px-6 pt-20">
          ...
          <section className="flex max-w-3xl flex-col items-center text-center">
            ...
            <p className="mt-6 max-w-[540px] text-xl leading-relaxed text-[#7b716d]">
              A Vision organiza e melhora o acesso ao tratamento odontológico
              para pessoas em situação de vulnerabilidade. Juntos, podemos fazer
              a diferença.
            </p>
          ...
          <Link
            to="/"
            className="mt-5 flex items-center gap-1 px-5 py-5 text-sm font-semibold text-orange-600 transition hover:text-orange-700"
          >
